...
import type { CribbageRecord } from './types.ts'
...
export function isLeaderboardGame(record: CribbageRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: CribbageRecord[]): LeaderboardEntry[] {
