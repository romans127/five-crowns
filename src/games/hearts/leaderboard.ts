...
import type { HeartsRecord } from './types.ts'
...
export function isLeaderboardGame(record: HeartsRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: HeartsRecord[]): LeaderboardEntry[] {
