...
import type { TtrRecord } from './types.ts'
...
export function isLeaderboardGame(record: TtrRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: TtrRecord[]): LeaderboardEntry[] {
