...
import type { GinRecord } from './types.ts'
...
export function isLeaderboardGame(record: GinRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: GinRecord[]): LeaderboardEntry[] {
