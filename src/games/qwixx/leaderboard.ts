...
import type { QwixxRecord } from './types.ts'
...
export function isLeaderboardGame(record: QwixxRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: QwixxRecord[]): LeaderboardEntry[] {
