...
import type { SequenceRecord } from './types.ts'
...
export function isLeaderboardGame(record: SequenceRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: SequenceRecord[]): LeaderboardEntry[] {
