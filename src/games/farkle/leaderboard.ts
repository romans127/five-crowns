...
import type { FarkleRecord } from './types.ts'
...
export function isLeaderboardGame(record: FarkleRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: FarkleRecord[]): LeaderboardEntry[] {
