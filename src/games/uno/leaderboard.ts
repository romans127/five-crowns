...
import type { UnoRecord } from './types.ts'
...
export function isLeaderboardGame(record: UnoRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: UnoRecord[]): LeaderboardEntry[] {
