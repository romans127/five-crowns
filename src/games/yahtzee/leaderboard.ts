...
import type { YahtzeeRecord } from './types.ts'
...
export function isLeaderboardGame(record: YahtzeeRecord): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: YahtzeeRecord[]): LeaderboardEntry[] {
