...
import type { Phase10Record } from './types.ts'
...
export function isLeaderboardGame(record: Phase10Record): boolean {
  return record.status === 'finished'
}

export function buildLeaderboard(records: Phase10Record[]): LeaderboardEntry[] {
